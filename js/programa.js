const encriptar = () => {
  ...
  let texto = document.querySelector(".texto-entrada").value.toLowerCase();
    ...
    for (let i = 0; i < texto.length; i++) {
      ...
      document.querySelector(".titulo-der").textContent= "Mensaje Encriptado";
...
const desencriptar = () => {
  ...
  document.querySelector(".texto-entrada").value = "";
  document.querySelector(".texto-entrada").placeholder = "Ingrese texto aquí"
  document.querySelector(".titulo-der").textContent= "Mensaje Desencriptado";
};
...
const copiar = () => {
  ...
  document.querySelector(".texto-entrada").placeholder = "Pega el texto aqui"
  document.querySelector(".titulo-der").textContent= "Mensaje Copiado";
